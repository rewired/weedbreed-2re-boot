...
export type { EconomyLedgerEntryReadModel, EconomyReadModel } from './economyTypes.js';
export type {
...
export interface ZoneReadModel {
  ...
  readonly plants: readonly PlantReadModel[];
  readonly harvestEligibility: HarvestEligibilityReadModel;
  readonly sowEligibility: SowEligibilityReadModel;
  readonly strainChoices: readonly StrainChoiceReadModel[];
}

export interface PlantReadModel {
  readonly id: string;
  readonly strainId: string;
...
/** Stable reason codes explaining why a zone cannot be harvested. */
export type HarvestEligibilityReason = "no-harvest-ready-plants";

/** Authoritative selection of currently harvestable plants in one zone. */
export interface HarvestEligibilityReadModel {
  readonly eligible: boolean;
  readonly plantIds: readonly string[];
  readonly reasons: readonly HarvestEligibilityReason[];
}

export type SowEligibilityReason =
  | "zone-not-empty"
  | "capacity-exhausted"
  | "missing-prerequisites";

export interface SowEligibilityReadModel {
  readonly eligible: boolean;
  readonly reasons: readonly SowEligibilityReason[];
  readonly capacityRemaining: number;
}

export interface StrainChoiceReadModel {
  readonly strainId: string;
  readonly slug: string;
  readonly name: string;
...
export type ZoneMissingPrerequisite =
  | "cultivation-method"
  | "container"
  | "substrate"
  | "irrigation"
...
export interface ZoneReadiness {
  ...
  readonly missingPrerequisites: readonly ZoneMissingPrerequisite[];
}
