...
import { useTelemetryStore } from "@ui/state/telemetry";
import type {
  DeviceSummary,
  RoomReadModel,
  TimelineEntry,
...
import { buildRoomControlCards } from "./roomDetailControls";
import { formatDeviceClass } from "./zoneDetailHelpers";
...
function toDeviceListItem(room: RoomReadModel, device: DeviceSummary): RoomDeviceListItem {
  ...
  const actions: readonly RoomDeviceAction[] = [];
