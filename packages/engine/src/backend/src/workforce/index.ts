...
import { emitWorkforceTelemetry } from './telemetry/workforceEmit.ts';

/* eslint-disable @typescript-eslint/no-magic-numbers -- Workforce KPIs use fixed percentile thresholds */
import {
  appendCultivationTasks,
  applyMaintenanceRuntime,
  ensureWorkforceState,
  isZoneQuarantined,
  processHrAssignIntents,
  processManualTaskIntents,
  resolveStructureMaps,
} from './runtimeProcessing.ts';
