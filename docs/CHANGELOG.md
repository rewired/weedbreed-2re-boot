...
- Task 0029: Introduced the zone detail page skeleton with reusable metric cards, stubbed `useZoneDetailSnapshot` metadata/telemetry store, device coverage summaries, disabled intent action placeholders referencing follow-up tasks, and Vitest coverage asserting all metric placeholders and tooltips.
