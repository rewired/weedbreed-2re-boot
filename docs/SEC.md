...
| [tasks/0002-co2-actuator-and-environment-coupling.md](./tasks/0002-co2-actuator-and-environment-coupling.md) | CO₂ Actuator and Environment Coupling | Define injector interface, couple zone CO₂ dynamics, and wire energy costs with deterministic tests. | [§6](#6-environment--devices-well-mixed-baseline); [§10](#10-economy-integration-non-intrusive) | deferred | Stub + environment wiring remain to ship per [TDD Tick Pipeline](./TDD.md#tick-pipeline-canonical-9-phases) sequencing. |
